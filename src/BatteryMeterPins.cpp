...
void BatteryMeterPins::setLightPins(unsigned int ledPins[], LEVEL maxLevel, uint8_t ledOnLevel)
{
  BatteryMeter::setLightPins(ledPins, maxLevel, ledOnLevel);
...
void BatteryMeterPins::setLights(LEVEL level)
{
